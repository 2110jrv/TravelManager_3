...
export function renderSettings({profile,authUser,access,remoteStatus='online',trip}={}){
  ...
  <div class="settings-stack">
    ...
    ${role==='ADMIN'?'<details class="settings-section" open><summary>Administración</summary><div class="settings-body"><button class="secondary" data-view="admin">Dispositivos y auditoría</button><button class="secondary" data-view="admin-users">Usuarios y permisos</button></div></details>':''}
  </div>`;
}

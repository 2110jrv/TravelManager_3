...
export function renderSettings({profile,authUser,access,remoteStatus='online',trip}={}){
  ...
  <div class="settings-stack">
    <details class="settings-section" open><summary>Viaje</summary><div class="settings-body"><strong data-trip-name="${esc(trip?.name||'Italy October/November 2026')}">${esc(trip?.name||'Italy October/November 2026')}</strong><span>20 oct – 5 nov 2026 · Jonathan & Jennifer</span></div></details>
    <details class="settings-section" open><summary>Cuenta</summary><div class="settings-body"><dl class="settings-list"><div><dt>Nombre</dt><dd>${esc(profile?.display_name||'')}</dd></div><div><dt>Rol</dt><dd><span class="role-pill">${esc(role)}</span></dd></div></dl><p class="admin-security-note">El PIN de acceso solo puede asignarlo o restablecerlo un administrador.</p></div></details>
    ...
    ${role==='ADMIN'?'<details class="settings-section" open><summary>Administración</summary><div class="settings-body"><button class="secondary" data-view="admin">Dispositivos y auditoría</button><p class="admin-security-note">La gestión de usuarios y permisos requiere la sesión de administración segura.</p></div></details>':''}
  </div>`;
}

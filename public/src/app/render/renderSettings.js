...
export function renderSettings({profile,authUser,access,remoteStatus='online',trip}={}){
  ...
  <div class="settings-stack">
    ...
    <details class="settings-section"><summary>Cuenta</summary><div class="settings-body"><dl class="settings-list"><div><dt>Nombre</dt><dd>${esc(profile?.display_name||'')}</dd></div><div><dt>Rol</dt><dd><span class="role-pill">${esc(role)}</span></dd></div></dl><p class="admin-security-note">El PIN de acceso solo puede asignarlo o restablecerlo un administrador.</p></div></details>

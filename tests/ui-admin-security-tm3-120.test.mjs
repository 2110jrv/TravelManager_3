...
test('TM3-120 visual/admin surfaces expose secure controls',()=>{
  ...
  assert.match(settings,/Cambiar mi contraseña/);assert.match(settings,/Recuperación WhatsApp/);assert.match(settings,/Usuarios/);assert.doesNotMatch(settings,/password.*value=/i);

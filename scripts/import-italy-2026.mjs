...
function railCost(t){const n=(t.PassengersConfirmed||[]).length||2;const chf=(t.PassengersConfirmed||[]).reduce((a,p)=>a+Number(p.PriceCHF||0),0);if(chf)return{kind:'EXACT',currency:'CHF',amount:chf};const ref=t.TransportID;const amounts={'TRAIN_2026-10-21_FCO_ROMA_LEONARDO':14*n,'TRAIN_2026-10-21_ROMA_VENEZIA_9428':42.90*n,'TRAIN_2026-10-24_VENEZIA_MILANO_8974':102.80,'TRAIN_2026-10-24_MILANO_TIRANO_2822':null,'TRAIN_2026-10-26_TIRANO_MILANO_2815':12.50*n,'TRAIN_2026-10-26_MILANO_GENOVA_659':null,'TRAIN_2026-10-26_GENOVA_PISA_511':null,'TRAIN_2026-10-28_FIRENZE_NAPOLI_8902':57.80,'TRAIN_2026-11-02_NAPOLI_ROMA_9940':61.80};return amounts[ref]!=null?{kind:'EXACT',currency:'EUR',amount:amounts[ref]}:{kind:'UNKNOWN',currency:null,amount:null}}

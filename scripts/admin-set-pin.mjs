...
async function main(){
  ...
  let pin=await hiddenPrompt('Nuevo PIN ADMIN de 4 dígitos: ');if(!/^\d{4}$/.test(pin))throw Error('El PIN debe tener exactamente 4 dígitos.');
